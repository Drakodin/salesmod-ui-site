...
const Card = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: {
      ...
      ?
        h("div", { class: "card-image" }, h("img", { src: this.image.src }))
      :
        h("div", { id: "no-image-filler" }), h("slot", { name: "title" }), h("slot", { name: "description" }), h("slot", { name: "price" }))));
  }
};
Card.style = cardCss;
